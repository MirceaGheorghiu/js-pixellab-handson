 ...
 * numite skill1 si skill3, apoi folosind aceaste variabile,
 * afiseaza intr-un paragraf propozitia: “Cunosc html si css.”.
 * Intr-un mod similar destructureaza arrayul friends
 * pentru a obtine obiectul de pe pozitia 1 apoi destructureaza obiectul obtinut
 *  in variabilele friend2Name, friend2Surname si friend2Age astfel incat
 * sa le poti folosi in propozitia: Ma numesc Steven Stevenson si am 31 de ani.
...
console.log(`Persona ${hasPet === true ? 'are' : 'nu are'} animale.`);
